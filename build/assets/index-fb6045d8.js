(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const a of l)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(l){const a={};return l.integrity&&(a.integrity=l.integrity),l.referrerPolicy&&(a.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?a.credentials="include":l.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(l){if(l.ep)return;l.ep=!0;const a=n(l);fetch(l.href,a)}})();/*! (c) Andrea Giammarchi - ISC */var A={};try{A.WeakMap=WeakMap}catch{A.WeakMap=function(e,n){var s=n.defineProperty,l=n.hasOwnProperty,a=i.prototype;return a.delete=function(r){return this.has(r)&&delete r[this._]},a.get=function(r){return this.has(r)?r[this._]:void 0},a.has=function(r){return l.call(r,this._)},a.set=function(r,o){return s(r,this._,{configurable:!0,value:o}),this},i;function i(r){s(this,"_",{value:"_@ungap/weakmap"+e++}),r&&r.forEach(c,this)}function c(r){this.set(r[0],r[1])}}(Math.random(),Object)}const S=A.WeakMap;/*! (c) Andrea Giammarchi - ISC */var m="-"+Math.random().toFixed(6)+"%",N=!1;try{(function(t,e,n){return e in t&&(t.innerHTML="<p "+n+'="'+m+'"></p>',t[e].childNodes[0].getAttribute(n)==m)})(document.createElement("template"),"content","tabindex")||(m="_dt: "+m.slice(1,-1)+";",N=!0)}catch{}var Z="<!--"+m+"-->",a1=8,c1=1,o1=3,I=/^(?:plaintext|script|style|textarea|title|xmp)$/i,C1=/^(?:area|base|br|col|embed|hr|img|input|keygen|link|menuitem|meta|param|source|track|wbr)$/i;/*! (c) Andrea Giammarchi - ISC */function f1(t){return t.join(Z).replace(h1,m1).replace(u1,p1)}var B=" \\f\\n\\r\\t",U="[^"+B+`\\/>"'=]+`,$="["+B+"]+"+U,K="<([A-Za-z]+[A-Za-z0-9:._-]*)((?:",X=`(?:\\s*=\\s*(?:'[^']*?'|"[^"]*?"|<[^>]*?>|`+U.replace("\\/","")+"))?)",u1=new RegExp(K+$+X+"+)(["+B+"]*/?>)","g"),h1=new RegExp(K+$+X+"*)(["+B+"]*/>)","g"),v1=new RegExp("("+$+`\\s*=\\s*)(['"]?)`+Z+"\\2","gi");function p1(t,e,n,s){return"<"+e+n.replace(v1,g1)+s}function g1(t,e,n){return e+(n||'"')+m+(n||'"')}function m1(t,e,n){return C1.test(e)?t:"<"+e+n+"></"+e+">"}const{isArray:E}=Array,{indexOf:c2,slice:L}=[],O=t=>({get:e=>t.get(e),set:(e,n)=>(t.set(e,n),n)}),w1=1,Y=111,d1=({firstChild:t,lastChild:e})=>{const n=document.createRange();return n.setStartAfter(t),n.setEndAfter(e),n.deleteContents(),t},M=(t,e)=>t.nodeType===Y?1/e<0?e?d1(t):t.lastChild:e?t.valueOf():t.firstChild:t,x1=t=>{const{childNodes:e}=t,{length:n}=e;if(n<2)return n?e[0]:t;const s=L.call(e,0),l=s[0],a=s[n-1];return{ELEMENT_NODE:w1,nodeType:Y,firstChild:l,lastChild:a,valueOf(){if(e.length!==n){let i=0;for(;i<n;)t.appendChild(s[i++])}return t}}};/*! (c) Andrea Giammarchi - ISC */var J=function(t){var e="fragment",n="template",s="content"in i(n),l=s?function(r){var o=i(n);return o.innerHTML=r,o.content}:function(r){var o=i(e),C=i(n),u=null;if(/^[^\S]*?<(col(?:group)?|t(?:head|body|foot|r|d|h))/i.test(r)){var h=RegExp.$1;C.innerHTML="<table>"+r+"</table>",u=C.querySelectorAll(h)}else C.innerHTML=r,u=C.childNodes;return a(o,u),o};return function(o,C){return(C==="svg"?c:l)(o)};function a(r,o){for(var C=o.length;C--;)r.appendChild(o[0])}function i(r){return r===e?t.createDocumentFragment():t.createElementNS("http://www.w3.org/1999/xhtml",r)}function c(r){var o=i(e),C=i("div");return C.innerHTML='<svg xmlns="http://www.w3.org/2000/svg">'+r+"</svg>",a(o,C.firstChild.childNodes),o}}(document);const k=(t,e,n,s,l)=>{const a=n.length;let i=e.length,c=a,r=0,o=0,C=null;for(;r<i||o<c;)if(i===r){const u=c<a?o?s(n[o-1],-0).nextSibling:s(n[c-o],0):l;for(;o<c;)t.insertBefore(s(n[o++],1),u)}else if(c===o)for(;r<i;)(!C||!C.has(e[r]))&&t.removeChild(s(e[r],-1)),r++;else if(e[r]===n[o])r++,o++;else if(e[i-1]===n[c-1])i--,c--;else if(e[r]===n[c-1]&&n[o]===e[i-1]){const u=s(e[--i],-1).nextSibling;t.insertBefore(s(n[o++],1),s(e[r++],-1).nextSibling),t.insertBefore(s(n[--c],1),u),e[i]=n[c]}else{if(!C){C=new Map;let u=o;for(;u<c;)C.set(n[u],u++)}if(C.has(e[r])){const u=C.get(e[r]);if(o<u&&u<c){let h=r,p=1;for(;++h<i&&h<c&&C.get(e[h])===u+p;)p++;if(p>u-o){const v=s(e[r],0);for(;o<u;)t.insertBefore(s(n[o++],1),v)}else t.replaceChild(s(n[o++],1),s(e[r++],-1))}else r++}else t.removeChild(s(e[r++],-1))}return n};/*! (c) Andrea Giammarchi - ISC */var b1=function(t,e,n,s,l){var a=l in t,i=t.createDocumentFragment();i[e](t[s]("g")),i[e](t[s](""));var c=a?t[l](i,!0):i[n](!0);return c.childNodes.length<2?function r(o,C){for(var u=o[n](),h=o.childNodes||[],p=h.length,v=0;C&&v<p;v++)u[e](r(h[v],C));return u}:a?t[l]:function(r,o){return r[n](!!o)}}(document,"appendChild","cloneNode","createTextNode","importNode"),Q="".trim||function(){return String(this).replace(/^\s+|\s+/g,"")},y1=N?function(t,e){var n=e.join(" ");return e.slice.call(t,0).sort(function(s,l){return n.indexOf(s.name)<=n.indexOf(l.name)?-1:1})}:function(t,e){return e.slice.call(t,0)};function M1(t,e){for(var n=e.length,s=0;s<n;)t=t.childNodes[e[s++]];return t}function t1(t,e,n,s){for(var l=t.childNodes,a=l.length,i=0;i<a;){var c=l[i];switch(c.nodeType){case c1:var r=s.concat(i);k1(c,e,n,r),t1(c,e,n,r);break;case a1:var o=c.textContent;if(o===m)n.shift(),e.push(I.test(t.nodeName)?G(t,s):L1(c,s.concat(i)));else switch(o.slice(0,2)){case"/*":if(o.slice(-2)!=="*/")break;case"👻":t.removeChild(c),i--,a--}break;case o1:I.test(t.nodeName)&&Q.call(c.textContent)===Z&&(n.shift(),e.push(G(t,s)));break}i++}}function k1(t,e,n,s){for(var l=t.attributes,a=[],i=[],c=y1(l,n),r=c.length,o=0;o<r;){var C=c[o++],u=C.value===m,h;if(u||1<(h=C.value.split(Z)).length){var p=C.name;if(a.indexOf(p)<0){a.push(p);var v=n.shift().replace(u?/^(?:|[\S\s]*?\s)(\S+?)\s*=\s*('|")?$/:new RegExp("^(?:|[\\S\\s]*?\\s)("+p+`)\\s*=\\s*('|")[\\S\\s]*`,"i"),"$1"),d=l[v]||l[v.toLowerCase()];if(u)e.push(P(d,s,v,null));else{for(var x=h.length-2;x--;)n.shift();e.push(P(d,s,v,h))}}i.push(C)}}r=i.length,o=0;for(var H=0<r&&N&&!("ownerSVGElement"in t);o<r;){var w=i[o++];H&&(w.value=""),t.removeAttribute(w.name)}var b=t.nodeName;if(/^script$/i.test(b)){var y=document.createElement(b);for(r=l.length,o=0;o<r;)y.setAttributeNode(l[o++].cloneNode(!0));y.textContent=t.textContent,t.parentNode.replaceChild(y,t)}}function L1(t,e){return{type:"any",node:t,path:e}}function P(t,e,n,s){return{type:"attr",node:t,path:e,name:n,sparse:s}}function G(t,e){return{type:"text",node:t,path:e}}var j=O(new S);function T1(t,e){var n=(t.convert||f1)(e),s=t.transform;s&&(n=s(n));var l=J(n,t.type);e1(l);var a=[];return t1(l,a,e.slice(0),[]),{content:l,updates:function(i){for(var c=[],r=a.length,o=0,C=0;o<r;){var u=a[o++],h=M1(i,u.path);switch(u.type){case"any":c.push({fn:t.any(h,[]),sparse:!1});break;case"attr":var p=u.sparse,v=t.attribute(h,u.name,u.node);p===null?c.push({fn:v,sparse:!1}):(C+=p.length-2,c.push({fn:v,sparse:!0,values:p}));break;case"text":c.push({fn:t.text(h),sparse:!1}),h.textContent="";break}}return r+=C,function(){var d=arguments.length;if(r!==d-1)throw new Error(d-1+" values instead of "+r+`
`+e.join("${value}"));for(var x=1,H=1;x<d;){var w=c[x-H];if(w.sparse){var b=w.values,y=b[0],D=1,_=b.length;for(H+=_-2;D<_;)y+=arguments[x++]+b[D++];w.fn(y)}else w.fn(arguments[x++])}return i}}}}function H1(t,e){var n=j.get(e)||j.set(e,T1(t,e));return n.updates(b1.call(document,n.content,!0))}var E1=[];function z1(t){var e=E1,n=e1;return function(s){return e!==s&&(n=H1(t,e=s)),n.apply(null,arguments)}}function e1(t){for(var e=t.childNodes,n=e.length;n--;){var s=e[n];s.nodeType!==1&&Q.call(s.textContent).length===0&&t.removeChild(s)}}/*! (c) Andrea Giammarchi - ISC */var Z1=function(){var t=/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,e=/([^A-Z])([A-Z]+)/g;return function(c,r){return"ownerSVGElement"in c?s(c,r):a(c.style,!1)};function n(i,c,r){return c+"-"+r.toLowerCase()}function s(i,c){var r;return c?r=c.cloneNode(!0):(i.setAttribute("style","--hyper:style;"),r=i.getAttributeNode("style")),r.value="",i.setAttributeNode(r),a(r,!0)}function l(i){var c,r=[];for(c in i)r.push(c.replace(e,n),":",i[c],";");return r.join("")}function a(i,c){var r,o;return function(C){var u,h,p,v;switch(typeof C){case"object":if(C){if(r==="object"){if(!c&&o!==C)for(h in o)h in C||(i[h]="")}else c?i.value="":i.cssText="";u=c?{}:i;for(h in C)v=C[h],p=typeof v=="number"&&!t.test(h)?v+"px":v,!c&&/^--/.test(h)?u.setProperty(h,p):u[h]=p;r="object",c?i.value=l(o=u):o=C;break}default:o!=C&&(r="string",o=C,c?i.value=C||"":i.cssText=C||"");break}}}}();const B1=t=>e=>{for(const n in e){const s=n==="role"?n:`aria-${n}`,l=e[n];l==null?t.removeAttribute(s):t.setAttribute(s,l)}},F=(t,e)=>{let n,s=!0;const l=document.createAttributeNS(null,e);return a=>{n!==a&&(n=a,n==null?s||(t.removeAttributeNode(l),s=!0):(l.value=a,s&&(t.setAttributeNodeNS(l),s=!1)))}},V1=(t,e,n)=>s=>{n!==!!s&&((n=!!s)?t.setAttribute(e,""):t.removeAttribute(e))},n1=({dataset:t})=>e=>{for(const n in e){const s=e[n];s==null?delete t[n]:t[n]=s}},A1=(t,e)=>{let n,s=e.slice(2);return!(e in t)&&e.toLowerCase()in t&&(s=s.toLowerCase()),l=>{const a=E(l)?l:[l,!1];n!==a[0]&&(n&&t.removeEventListener(s,n,a[1]),(n=a[0])&&t.addEventListener(s,n,a[1]))}},S1=t=>e=>{typeof e=="function"?e(t):e.current=t},R=(t,e)=>e==="dataset"?n1(t):n=>{t[e]=n},N1=(t,e)=>{let n;return s=>{n!==s&&(n=s,t[e]!==s&&(s==null?(t[e]="",t.removeAttribute(e)):t[e]=s))}},$1=/^(?:form|list)$/i,O1=(t,e)=>t.ownerDocument.createTextNode(e);function s1(t){return this.type=t,z1(this)}s1.prototype={attribute(t,e,n){const s=this.type==="svg";switch(e){case"class":if(s)return F(t,e);e="className";case"props":return R(t,e);case"aria":return B1(t);case"style":return Z1(t,n,s);case"ref":return S1(t);case".dataset":return n1(t);default:return e.slice(0,1)==="."?R(t,e.slice(1)):e.slice(0,1)==="?"?V1(t,e.slice(1)):e.slice(0,2)==="on"?A1(t,e):e in t&&!(s||$1.test(e))?N1(t,e):F(t,e)}},any(t,e){const{type:n}=this;let s=!1,l;const a=i=>{switch(typeof i){case"string":case"number":case"boolean":s?l!==i&&(l=i,e[0].textContent=i):(s=!0,l=i,e=k(t.parentNode,e,[O1(t,i)],M,t));break;case"function":a(i(t));break;case"object":case"undefined":if(i==null){s=!1,e=k(t.parentNode,e,[],M,t);break}default:if(s=!1,l=i,E(i))if(i.length===0)e.length&&(e=k(t.parentNode,e,[],M,t));else switch(typeof i[0]){case"string":case"number":case"boolean":a(String(i));break;case"function":a(i.map(D1,t));break;case"object":E(i[0])&&(i=i.concat.apply([],i));default:e=k(t.parentNode,e,i,M,t);break}else"ELEMENT_NODE"in i?e=k(t.parentNode,e,i.nodeType===11?L.call(i.childNodes):[i],M,t):"text"in i?a(String(i.text)):"any"in i?a(i.any):"html"in i?e=k(t.parentNode,e,L.call(J([].concat(i.html).join(""),n).childNodes),M,t):"length"in i&&a(L.call(i));break}};return a},text(t){let e;const n=s=>{if(e!==s){e=s;const l=typeof s;l==="object"&&s?"text"in s?n(String(s.text)):"any"in s?n(s.any):"html"in s?n([].concat(s.html).join("")):"length"in s&&n(L.call(s).join("")):l==="function"?n(s(t)):t.textContent=s??""}};return n}};function D1(t){return t(this)}const{create:_1,freeze:I1,keys:o2}=Object,q=O(new S),P1=t=>({html:W("html",t),svg:W("svg",t),render(e,n){const s=typeof n=="function"?n():n,l=q.get(e)||q.set(e,T()),a=s instanceof V?z(t,l,s):s;return a!==l.wire&&(l.wire=a,e.textContent="",e.appendChild(a.valueOf())),e}}),T=()=>({stack:[],entry:null,wire:null}),W=(t,e)=>{const n=O(new S),s=a=>function(){return z(e,a,l.apply(null,arguments))};return l.for=(a,i)=>{const c=n.get(a)||n.set(a,_1(null));return c[i]||(c[i]=s(T()))},l.node=function(){return z(e,T(),l.apply(null,arguments)).valueOf()},l;function l(){return new V(t,j1.apply(null,arguments))}},z=(t,e,{type:n,template:s,values:l})=>{const{length:a}=l;i1(t,e,l,a);let{entry:i}=e;if(!i||i.template!==s||i.type!==n){const c=new t(n);e.entry=i={type:n,template:s,tag:c,wire:x1(c(s,...l))}}else i.tag(s,...l);return i.wire},i1=(t,{stack:e},n,s)=>{for(let l=0;l<s;l++){const a=n[l];a instanceof G1?n[l]=z(t,e[l]||(e[l]=T()),a):E(a)?i1(t,e[l]||(e[l]=T()),a,a.length):e[l]=null}s<e.length&&e.splice(s)};I1(V);function V(t,e){this.type=t,this.template=e.shift(),this.values=e}const G1=V,{render:C2,html:f,svg:f2}=P1(s1);function j1(){let t=[],e=0,{length:n}=arguments;for(;e<n;)t.push(arguments[e++]);return t}const F1="Glitch in Bio!",R1="My meta description.",q1="Glitch in Bio",W1="glitch",U1="https://cdn.glitch.com/560ed5ed-9d00-433a-9ff9-7750d79d13da%2FGlitch_TeamAvatar.png?v=1624643105812",l1=[{url:"https://glitch.new/links",text:"Remix! Have your own Glitch-in-bio running in seconds.",img:"https://cdn.glitch.me/efc5414a-882b-4708-af81-8461abbc1a82%2Fglitchmidblues.png?v=1634289872484",altText:"Glitch blue generative art"},{url:"https://glitch.com/edit/#!/glitch-in-bio?path=README.md",text:"View source! Check out the code to see how it's built.",img:""},{url:"https://www.glitch.com/",text:"Built by and on Glitch, the easiest way to build the web.",img:"https://cdn.glitch.me/efc5414a-882b-4708-af81-8461abbc1a82%2Fglitchdarkpinks.png?v=1634289859236"}],K1={glitch:"https://glitch.com/",arena:"",bandcamp:"",bluesky:"https://bsky.app/profile/glitch.com",cohost:"",dev:"https://dev.to/glitch",facebook:"",github:"https://github.com/glitchdotcom",gitlab:"",hashnode:"",instagram:"",keybase:"",kofi:"",letterboxd:"",linkedin:"https://www.linkedin.com/company/fog-creek-software",mastodon:"https://mastodon.social/@glitchdotcom",medium:"",onlyfans:"",patreon:"",pinboard:"",pinterest:"",pixelfed:"",podcast:"",soundcloud:"",spotify:"",stackoverflow:"",substack:"",twitter:"https://twitter.com/glitch",twitch:"",tiktok:"",tumblr:"",youtube:"https://www.youtube.com/c/GlitchDotCom",email:"support@glitch.com"},g={metaTitle:F1,metaDescription:R1,name:q1,theme:W1,avatarImage:U1,links:l1,social:K1},X1=f.node`
